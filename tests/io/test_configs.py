...
def test_parse_file(tmp_path: str) -> None:
    ...
    # then
    assert config == {"a": 1, "b": True, "c": [3, 4]}, (
...
def test_parse_string() -> None:
    ...
    # then
    assert config == {"a": 1, "b": 2, "data": [3, 4]}, (
...
def test_merge_configs() -> None:
    ...
    # then
    assert config == {0: 0, 1: 1, 2: 2, "x": 2}, "Configs should be merged correctly!"
