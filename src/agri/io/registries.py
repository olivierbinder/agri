...
type Info = mlflow.models.model.ModelInfo
type Alias = mlflow.entities.model_registry.ModelVersion  # ty: ignore
type Version = mlflow.entities.model_registry.ModelVersion  # ty: ignore
...
class BuiltinLoader(Loader):
    ...
    class Adapter(Loader.Adapter):
        ...
        def predict(self, inputs: schemas.Inputs) -> schemas.Outputs:
            ...
            return schemas.Outputs(outputs, columns=columns, index=inputs.index)  # ty: ignore
